...
"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": فعال برای صعودی مرتب کردن ستون",sSortDescending:": فعال برای نزولی مرتب کردن ستون  "},oPaginate:{sFirst:"اولین",sLast:"آخرین",sNext:"بعدی",sPrevious:"قبلی"},
sEmptyTable:"در جدول داده ای در دست نیست",sInfo:"نمایش  _START_ تا _END_ از _TOTAL_ سطر",sInfoEmpty:"نمایش 0 تا 0 از 0 سطر",sInfoFiltered:"(فیلترشده از _MAX_  سطر)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"نمایش _MENU_ سطر",sLoadingRecords:"اندکی صبر...",sProcessing:"در حال پردازش...",sSearch:"جستجو:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"رکور  دی پیدا نشد!"},oSearch:h.extend({},m.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};
